	...
	for i := 0; i < MAX; i++ {
		for o := 0; o < MAX; o++ {
			for d := 1; d <= i; d++ {
				...
				P(pf("// Clos%d%d%d with func( %d in)(%d out) closure first %d argument \n", i, o, d, i, o, d))
				ts := i + o
				P(pf(`func Clos%d%d%d[`, i, o, d), n(ts, A), p(` any](`), r(0, d, aA), w(d > 0, ","), p(`fn func(`), n(i, A), p(`)`), q(o > 1, r(i, i+o, A)), p(` )func(`), r(d, i, A), p(")"), q(o > 1, r(i, ts, A)), p(`{
...
`))
				...
				P(pf("// ClosLast%d%d%d with func( %d in)(%d out) fix last %d argument \n", i, o, d, i, o, d))
				P(pf(`func ClosLast%d%d%d[`, i, o, d), n(ts, A), p(` any](`), r(i-d, i, aA), w(d > 0, ","), p(`fn func(`), n(i, A), p(`)`), q(o > 1, r(i, i+o, A)), p(` )func(`), r(0, i-d, A), p(")"), q(o > 1, r(i, i+o, A)), p(`{
...
func genPanicsFn() {
	...
	no:
		for o := 0; o < MAX; o++ {
			...
			P(pf("// Panics%d%d panic with func %d in %d out (last out is an error), returns a Runnable.\n", i, o, i, o+1))
			P(pf(`func Panics%d%d[`, i, o), n(i+o, A), p(` any](`), n(i, aA), w(i > 0, ","), p(` fn func(`), n(i, A), p(`)`), w(o > 0, "("), r(i, i+o, A), w(o > 0, ","), p(`error`), w(o > 0, ")"), p(` )func()`), p(`{
	return func(){
		var err error
