...
func Error(arg ...any) error {
	return errors.New(fmt.Sprint(append([]any{CallerShortFileN(1), " "}, arg...)...))
}

//Errorf create new error with line info
func Errorf(pattern string, arg ...any) error {
	return errors.New(fmt.Sprintf("%s "+pattern, append([]any{CallerShortFileN(1), " "}, arg...)...))
}
